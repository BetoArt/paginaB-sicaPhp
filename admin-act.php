...
// Selecciono / muestro el id del usuario a modificar
$id = $_GET ['id']; 

$consultas = mysqli_query( $conexion, "select * from users where id=$id");
?>
...
<html lang="en">
    ...
    <title>Actualizar registro (Administrador)</title>
     <!-- Favicon-->
 ...
 Salir
   ...
   <main>
    <div id="main" class="card card-body border-0 ">
      ...
      <form action="fx/actualizar-admin.php" method="get">
      ...
      <?php while( $listado2022 = mysqli_fetch_array($consultas)) { ?>
        ...
        <input type="text" readonly class="form-control"  name="id" value="<?php echo  $listado2022['id']; ?>">
        ...
        <div class="col-12">
            ...
            <input type="email" class="form-control" id="floatingInput" placeholder="Correo" id="validationCustom01" required aria-label="Correo" id="email" name="email">
              ...
              <div id="fb">
                ...
                <div class="col-12">
                    <div class="mt-3"></div>
                    <input type="text" class="form-control" id="floatingInput" placeholder="Foto (por defecto tipear ´avatar.jpg´)" id="validationCustom01" required aria-label="Foto"  id="foto" name="foto">
                        </div>
                        </div>
                      </div>
